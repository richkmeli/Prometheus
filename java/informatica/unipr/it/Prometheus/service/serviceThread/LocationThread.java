...
public class LocationThread extends Thread {
    ...
    private void updateLocation(Location location) {
        ...
        if (settingSharedPreferences.getBoolean("isLocationActive", true)) {
            ...
            double latConfronto = Double.parseDouble(mapSharedPreferences.getString("latitude", "0"));
            double logConfronto = Double.parseDouble(mapSharedPreferences.getString("longitude", "0"));

            Location targetLocation = new Location("");
            targetLocation.setLatitude(latConfronto);
            targetLocation.setLongitude(logConfronto);
